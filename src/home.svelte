...
<main>
  ...
  <div id="projects" class= "projects_section">
    ...
    <div class="project_container">
      {#each projects as project}
        <ProjectTab proj_title={project.title} description={project.description} image={project.image} url = {project.link}/>
      {/each}
    </div>
  </div>

  <a class="portfolio_redirect" href="/portfolio" data-discover="true">
      <span class="page_ref">Games Portfolio</span>
      <hr class="underline"/>
  </a>
  ...
  <div id="resume" class= "resume_section">
    ...
    <a href="src/assets/Resume.png" download>
      <img class="resume_pdf" src="src/assets/images/personal/Resume.png" alt="My Resume"/>
    </a>
  </div>
  ...
  <div id="connections" class= "contact_section">
    ...
    <div class="contact_container">
      <a href="https://github.com/KodaIsshin" target="_blank" rel="noreferrer">
        <img class="github_img" src="src/assets/images/personal/github_logo.png" alt="GitHub" />
      </a>
      <a href="https://www.linkedin.com/in/keith-natakusuma-79785b2b8/">
        <img class="linkedin_img" src="src/assets/images/personal/linkedin_logo.png" alt="LinkedIn" />
      </a>
    </div>
  </div>
</main>
...
<style>
  ...
  .portfolio_redirect:hover .underline{
    width:100%;
    color: white;
  }
